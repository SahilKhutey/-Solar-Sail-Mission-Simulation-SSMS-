...
def test_monte_carlo_robustness():
    ...
    config = {
        ...
        'spacecraft': {'mass': 10.0, 'sail_area': 100.0, 'reflectivity': 0.9, 'inertia': [[1,0,0],[0,1,0],[0,0,1]]},
        'orbit': {'type': 'LEO', 'altitude_km': 700.0, 'inclination_deg': 28.5},
        'physics': {'gravity_model': 'two_body', 'perturbations': {'j2': False, 'srp': True, 'drag': False}, 'navigation': False},
