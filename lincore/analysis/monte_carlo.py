...
def run_monte_carlo(n_cases=50):
    ...
    base_config = {
        ...
        'spacecraft': {'mass': 10, 'sail_area': 100, 'reflectivity': 0.9, 'inertia': [[1,0,0],[0,1,0],[0,0,1]]},
        'orbit': {'type': 'LEO', 'altitude_km': 700.0, 'inclination_deg': 28.5},
        'physics': {'gravity_model': 'two_body', 'perturbations': {'j2': True, 'srp': True, 'drag': True}, 'navigation': False},
        'navigation': {'position_noise_km': 0.01, 'velocity_noise_kms': 0.001, 'attitude_noise_deg': 0.01, 'rate_noise_deg_s': 0.001},
    ...
    for seed in seeds:
        ...
        results.append(res)
        if seed % 10 == 0: print(f"Case {seed} done.")
